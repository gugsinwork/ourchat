      ...
      <div className="flex flex-wrap items-center justify-center h-[100vh]">
        <div className="flex flex-col max-sm:top-[60px] items-center justify-center relative bottom-10">
            ...
            <div className="flex space-x-2 mt-10">
              <button onClick={login} className="max-sm:bottom-[30px] w-[300px] max-sm:w-[200px] text-[19px] max-sm:text-[13px] relative justify-evenly text-center flex items-center p-[10px] bg-slate-50  text-black font-bold rounded-[15px] ">
        ...
        <div>
          ...
          width={600}
          className='max-sm:w-[300px] relative max-sm:bottom-[40px]'
          />
        </div>
    </div>
    </main>
