  ...
  return (
    <main className="flex flex-col items-center h-[100vh] bg-black">
      ...
      <div className="flex flex-wrap items-center justify-center h-[100vh]">
        <div className="flex flex-col max-sm:top-[60px] items-center justify-center relative bottom-10">
            <h1 className="text-5xl relative right-[45px] text-slate-50 max-sm:text-[22px] ">
            ...
            <div className="w-[300px] relative max-sm:bottom-5 max-sm:right-1 space-y-1 max-sm:text-[10px]">
            ...
            <div className="flex space-x-2 mt-10">
              <button onClick={login} className="max-sm:bottom-[30px] max-sm:text-[13px] relative text-center flex items-center p-[10px] bg-slate-50  text-black font-bold rounded-[15px] ">
